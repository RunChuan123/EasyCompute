...
struct Storage{
    ...
    void allocate() {
        ...
        switch (device.type()){ // TODO: 暂时先这样，cuda 也可以申请 cpu 上的内存，
            case DeviceType::CPU: mt = MemoryType::Host;break;
            case DeviceType::CUDA: mt = MemoryType::Device;break;
            case DeviceType::ASCEND : mt = MemoryType::Device;break;
        }
